...
class ApiService {
  static const String mockApiBaseUrl =
      'https://69063273ee3d0d14c13529b5.mockapi.io';
  static const String exchangeRateApiUrl = 'https://api.frankfurter.app/latest';
  static const String apparelApiUrl =
      'https://692f397f91e00bafccd6f9b3.mockapi.io/apparel';
  static const String aksesorisApiUrl =
      'https://692f397f91e00bafccd6f9b3.mockapi.io/aksesoris';
  ...
  Future<ExchangeRate> getExchangeRates() async {
    try {
      ...
      return ExchangeRate(usd: 0.000063, eur: 0.000058, jpy: 0.0095);
    }
  }
  ...
  Future<List<MotorBaru>> getMotorByBrand(String brand) async {
    try {
      ...
      return allMotors
          .where((motor) => motor.brand.toLowerCase() == brand.toLowerCase())
          .toList();
    } catch (e) {
      rethrow;
    }
  ...
  Future<double> convertFromUsd(double usdAmount, String targetCurrency) async {
    try {
      ...
      switch (targetCurrency) {
        case 'IDR':
          return usdAmount * 15800;
        case 'EUR':
          return usdAmount * 0.92;
        case 'JPY':
          return usdAmount * 149.5;
        default:
          return usdAmount;
      }
    }
